...
AddBinaryDialog::~AddBinaryDialog() { delete ui; }
...
QString AddBinaryDialog::executable() { return QDir::toNativeSeparators(ui->binaryEdit->text()); }

void AddBinaryDialog::on_browseButton_clicked() {
    ui->binaryEdit->setText(
        QFileDialog::getOpenFileName(this, tr("Select Executable"), QString(), tr("Executable (*.exe)")));
}
